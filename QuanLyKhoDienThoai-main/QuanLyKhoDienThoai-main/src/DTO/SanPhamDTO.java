...
public class SanPhamDTO {
    ...
    public SanPhamDTO copy() {
        SanPhamDTO copy = new SanPhamDTO();

        copy.masp = this.masp;
        copy.tensp = this.tensp;
        copy.hinhanh = this.hinhanh;
        copy.xuatxu = this.xuatxu;
        copy.chipxuly = this.chipxuly;
        copy.dungluongpin = this.dungluongpin;
        copy.kichthuocman = this.kichthuocman;
        copy.hedieuhanh = this.hedieuhanh;
        copy.phienbanhdh = this.phienbanhdh;
        copy.camerasau = this.camerasau;
        copy.cameratruoc = this.cameratruoc;
        copy.thoigianbaohanh = this.thoigianbaohanh;
        copy.thuonghieu = this.thuonghieu;
        copy.khuvuckho = this.khuvuckho;
        copy.soluongton = this.soluongton;
...
public class SanPhamDTOWP extends SanPhamDTO {
        private int maPBSP;

        public SanPhamDTOWP() {
        }

        public int getMaPBSP() {
            return maPBSP;
        }

        public void setMaPBSP(int maPBSP) {
            this.maPBSP = maPBSP;
        }
}
}
