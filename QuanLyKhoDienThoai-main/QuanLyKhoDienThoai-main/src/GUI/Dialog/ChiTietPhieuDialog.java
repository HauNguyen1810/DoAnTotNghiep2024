...
public final class ChiTietPhieuDialog extends JDialog implements ActionListener {
    ...
    public ChiTietPhieuDialog(JFrame owner, String title, boolean modal, DonDatHangDTO donDatHangDTO) {
        super(owner, title, modal);
        this.dondathang = donDatHangDTO;
        donDatHangBUS = new DonDatHangBUS();
        chitietphieu = donDatHangBUS.getChiTietPhieu_Type(donDatHangDTO.getMaphieu());
        chitietsanpham = ctspBus.getChiTietSanPhamFromMaPN(donDatHangDTO.getMaphieu());
        initComponent(title);
        initDonDatHang();
        loadDataTableChiTietPhieu(chitietphieu);
        this.setVisible(true);
    ...
    public void initDonDatHang() {
        txtMaPhieu.setText("DDH" + Integer.toString(this.dondathang.getMaphieu()));
        txtNhaCungCap.setText(NhaCungCapDAO.getInstance().selectById(dondathang.getManhacungcap() + "").getTenncc());
        txtNhanVien.setText(NhanVienDAO.getInstance().selectById(dondathang.getManguoitao() + "").getHoten());
        txtThoiGian.setText(Formater.FormatTime(dondathang.getThoigiantao()));
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == btnPdf) {
            ...
            if (this.dondathang != null) {
                w.writeDDH(dondathang.getMaphieu());
            }
        }
    }
}
